...
public class RequestRetryTestFactory implements RequestPolicyFactory {
    ...
    private final class RetryTestPolicy implements RequestPolicy {
                ...
                case RETRY_TEST_SCENARIO_EXPONENTIAL_TIMING:
                    switch (this.factory.tryNumber) {
                        ...
                        case 2:
                             ...
                             */
                            return testDelayBounds(2, RETRY_TEST_TEMPORARY_ERROR_RESPONSE);
                        case 3:
                            return testDelayBounds(3, RETRY_TEST_TEMPORARY_ERROR_RESPONSE);
                        case 4:
                            return testDelayBounds(4, RETRY_TEST_TEMPORARY_ERROR_RESPONSE);
                        case 5:
                            /*
                ...
                case RETRY_TEST_SCENARIO_FIXED_TIMING:
                    switch (this.factory.tryNumber) {
                        case 1:
                            ...
                            return RETRY_TEST_TEMPORARY_ERROR_RESPONSE;
                        case 2:
                            return testDelayBounds(1, RETRY_TEST_TEMPORARY_ERROR_RESPONSE);
                        case 3:
                            return testDelayBounds(2, RETRY_TEST_TEMPORARY_ERROR_RESPONSE);
                        case 4:
                            /*
        ...
        private OffsetDateTime calcUpperBound(OffsetDateTime start, int primaryTryNumber) {
            return start.plus(calcPrimaryDelay(primaryTryNumber) * 1000 + 500, ChronoUnit.MILLIS);
        }

        private OffsetDateTime calcLowerBound(OffsetDateTime start, int primaryTryNumber) {
            return start.plus(calcPrimaryDelay(primaryTryNumber) * 1000 - 500, ChronoUnit.MILLIS);
        }

        private Single<HttpResponse> testDelayBounds(int primaryTryNumber, Single<HttpResponse> response) {
            /*
            ...
            return new Single<HttpResponse>() {
                ...
                protected void subscribeActual(SingleObserver<? super HttpResponse> observer) {
                    try {
                        if (OffsetDateTime.now().isAfter(calcUpperBound(factory.time, primaryTryNumber)) ||
                                OffsetDateTime.now().isBefore(calcLowerBound(factory.time, primaryTryNumber))) {
