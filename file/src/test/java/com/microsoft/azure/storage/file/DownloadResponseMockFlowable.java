...
public class DownloadResponseMockFlowable extends Flowable<ByteBuffer> {
    ...
    public static final int DR_TEST_SCENARIO_SUCCESSFUL_ONE_RANGE = 0;

    public static final int DR_TEST_SCENARIO_SUCCESSFUL_MULTI_RANGE = 1;
    ...
    public DownloadResponseMockFlowable(int scenario) {
        ...
        switch (this.scenario) {
            case DR_TEST_SCENARIO_SUCCESSFUL_ONE_RANGE:
                this.scenarioData = APISpec.getRandomData(512 * 1024);
                break;
            case DR_TEST_SCENARIO_SUCCESSFUL_MULTI_RANGE:
                // Fall through
    ...
    public Single<DownloadResponse> getter(HTTPGetterInfo info) {
        this.tryNumber++;
        this.info = info;
        FileDownloadResponse rawResponse =
                new FileDownloadResponse(null, 200, new FileDownloadHeaders(), new HashMap<>(), this);
