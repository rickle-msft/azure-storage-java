...
class DownloadResponseTest extends APISpec {
    ...
    def setup() {
        ...
        fu.create(defaultText.length(),null,null,null).blockingGet()
        fu.uploadRange(new FileRange().withOffset(0).withCount(defaultText.length()), Flowable.just(defaultData), null).blockingGet()
    }
    ...
    def "Network call"() {
        expect:
        FlowableUtil.collectBytesInBuffer(fu.download(null, false, null).blockingGet().body(null))
    ...
    def "Successful"() {
        ...
        DownloadResponseMockFlowable.DR_TEST_SCENARIO_SUCCESSFUL_ONE_RANGE       | 1         | false
        DownloadResponseMockFlowable.DR_TEST_SCENARIO_SUCCESSFUL_MULTI_RANGE     | 1         | false
    ...
    def "Info null IA"() {
        ...
        def flowable = new DownloadResponseMockFlowable(
                DownloadResponseMockFlowable.DR_TEST_SCENARIO_SUCCESSFUL_ONE_RANGE)
