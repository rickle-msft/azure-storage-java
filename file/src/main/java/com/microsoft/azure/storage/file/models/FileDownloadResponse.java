 ...
 */
public final class FileDownloadResponse extends RestResponse<FileDownloadHeaders, Flowable<ByteBuffer>> implements Closeable {
    /**
     ...
     */
    public FileDownloadResponse(HttpRequest request, int statusCode, FileDownloadHeaders headers, Map<String, String> rawHeaders, Flowable<ByteBuffer> body) {
