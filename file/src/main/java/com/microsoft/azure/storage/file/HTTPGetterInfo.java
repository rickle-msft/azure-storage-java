...
public final class HTTPGetterInfo {
     ...
     * header. {@code} null is the default and indicates that the entire rest of the file should be retrieved.
     */
    public Long count() {
        return count;
    }
    ...
    /**
     * The resource's etag that should be used when verifying the file was not modified before making the request
     * and after getting the response. Note that the. Etag is returned with any operation that modifies the resource
     * and by a call to {@link FileURL#getProperties(Context)}. Defaults to null.
     */
    public String eTag() {
        return eTag;
    }
