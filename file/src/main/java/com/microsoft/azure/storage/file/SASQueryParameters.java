...
import static com.microsoft.azure.storage.file.Utility.safeURLEncode;
 ...
 * types. Once generated, it can be set on a object {@Link FileUrlParts}to be constructed as part of a URL or it can
...
public final class SASQueryParameters {
    ...
    /**
     * @return The storage share or resource (only for {@link ServiceSASSignatureValues}).
     */
    ...
    /**
     * @return Please refer to {@link AccountSASPermission}, {@link FileSASPermission}, or {@link ShareSASPermission}
     *         for more details.
     */
     ...
     * @param resource
     *         A {@code String} representing the storage share or file (only for Service SAS).
     * @param permissions
