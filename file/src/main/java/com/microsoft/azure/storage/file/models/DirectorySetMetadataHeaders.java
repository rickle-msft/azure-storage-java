...
public final class DirectorySetMetadataHeaders {
     ...
     */
    public DirectorySetMetadataHeaders withETag(String eTag) {
        this.eTag = eTag;
        return this;
    }
     ...
     * @return the DirectorySetMetadataHeaders object itself.
     */
    public DirectorySetMetadataHeaders withRequestId(String requestId) {
     ...
     * @return the DirectorySetMetadataHeaders object itself.
     */
    public DirectorySetMetadataHeaders withVersion(String version) {
     ...
     * @return the DirectorySetMetadataHeaders object itself.
     */
    public DirectorySetMetadataHeaders withDate(OffsetDateTime date) {
        if (date == null) {
            this.date = null;
        } else {
     ...
     * @return the DirectorySetMetadataHeaders object itself.
     */
    public DirectorySetMetadataHeaders withIsServerEncrypted(Boolean isServerEncrypted) {
