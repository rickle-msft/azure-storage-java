...
public final class DirectoryDeleteHeaders {
     ...
     */
    public DirectoryDeleteHeaders withRequestId(String requestId) {
     ...
     * @return the DirectoryDeleteHeaders object itself.
     */
    public DirectoryDeleteHeaders withVersion(String version) {
     ...
     * @return the DirectoryDeleteHeaders object itself.
     */
    public DirectoryDeleteHeaders withDate(OffsetDateTime date) {
        if (date == null) {
            this.date = null;
        } else {
