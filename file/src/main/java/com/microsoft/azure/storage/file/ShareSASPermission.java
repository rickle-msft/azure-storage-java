...
public final class ShareSASPermission {
     ...
     * Specifies Read access granted.
     */
    public ShareSASPermission withRead(boolean read) {
        this.read = read;
        return this;
    }
     ...
     * Specifies Add access granted.
     */
    public ShareSASPermission withAdd(boolean add) {
        this.add = add;
        return this;
    }
     ...
     * Specifies Create access granted.
     */
    public ShareSASPermission withCreate(boolean create) {
        this.create = create;
        return this;
    }
     ...
     * Specifies Write access granted.
     */
    public ShareSASPermission withWrite(boolean write) {
        this.write = write;
        return this;
    }
     ...
     * Specifies Delete access granted.
     */
    public ShareSASPermission withDelete(boolean delete) {
        this.delete = delete;
        return this;
    }
     ...
     * Specifies List access granted.
     */
    public ShareSASPermission withList(boolean list) {
        this.list = list;
        return this;
    }
