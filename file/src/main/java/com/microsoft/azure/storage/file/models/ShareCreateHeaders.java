...
public final class ShareCreateHeaders {
     ...
     */
    public ShareCreateHeaders withETag(String eTag) {
        this.eTag = eTag;
        return this;
    }
     ...
     * @return the ShareCreateHeaders object itself.
     */
    public ShareCreateHeaders withLastModified(OffsetDateTime lastModified) {
     ...
     * @return the ShareCreateHeaders object itself.
     */
    public ShareCreateHeaders withRequestId(String requestId) {
     ...
     * @return the ShareCreateHeaders object itself.
     */
    public ShareCreateHeaders withVersion(String version) {
     ...
     * @return the ShareCreateHeaders object itself.
     */
    public ShareCreateHeaders withDate(OffsetDateTime date) {
        if (date == null) {
            this.date = null;
        } else {
