...
public final class FileSASPermission {
     ...
     * Specifies Read access granted.
     */
    public FileSASPermission withRead(boolean read) {
        this.read = read;
        return this;
    }
     ...
     * Specifies Create access granted.
     */
    public FileSASPermission withCreate(boolean create) {
        this.create = create;
        return this;
    }
     ...
     * Specifies Write access granted.
     */
    public FileSASPermission withWrite(boolean write) {
        this.write = write;
        return this;
    }
     ...
     * Specifies Delete access granted.
     */
    public FileSASPermission withDelete(boolean delete) {
        this.delete = delete;
        return this;
    }

    /**
     * Initializes a {@code FileSASPermission} object with all fields set to false.
     */
    ...
    /**
     * Creates a {@code FileSASPermission} from the specified permissions string. This method will throw an
