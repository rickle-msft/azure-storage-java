...
public final class FileAbortCopyHeaders {
     ...
     */
    public FileAbortCopyHeaders withRequestId(String requestId) {
     ...
     * @return the FileAbortCopyHeaders object itself.
     */
    public FileAbortCopyHeaders withVersion(String version) {
     ...
     * @return the FileAbortCopyHeaders object itself.
     */
    public FileAbortCopyHeaders withDate(OffsetDateTime date) {
        if (date == null) {
            this.date = null;
        } else {
