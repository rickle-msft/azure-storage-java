...
public final class FileSetMetadataHeaders {
     ...
     */
    public FileSetMetadataHeaders withETag(String eTag) {
        this.eTag = eTag;
        return this;
    }
     ...
     * @return the FileSetMetadataHeaders object itself.
     */
    public FileSetMetadataHeaders withRequestId(String requestId) {
     ...
     * @return the FileSetMetadataHeaders object itself.
     */
    public FileSetMetadataHeaders withVersion(String version) {
     ...
     * @return the FileSetMetadataHeaders object itself.
     */
    public FileSetMetadataHeaders withDate(OffsetDateTime date) {
        if (date == null) {
            this.date = null;
        } else {
     ...
     * @return the FileSetMetadataHeaders object itself.
     */
    public FileSetMetadataHeaders withIsServerEncrypted(Boolean isServerEncrypted) {
