...
/**
 * Anonymous credentials are to be used with with HTTP(S) requests that read files from public shares or requests
...
public final class AnonymousCredentials implements ICredentials {
     ...
     * <a href=https://docs.microsoft.com/en-us/rest/api/storageservices/set-share-acl>Set Share ACL</a>
     */
