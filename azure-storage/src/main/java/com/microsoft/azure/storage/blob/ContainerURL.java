...
public final class ContainerURL extends StorageURL {
     ...
     *
     * @apiNote 
     * [!code-java[Sample_Code](~/azure-storage-java/test/java/com/microsoft/azure/storage/BlobStorageAPITests.java#Sample_code1 "Sample code for ContainerURL.create")]
     *
     * @param metadata
     *      {@link Metadata}
     * @param accessType
